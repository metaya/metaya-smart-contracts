...
// for that play's metadata in the Metaya contract. It returns
...
pub fun main(account: Address, momentID: UInt64, fieldToSearch: String): String {
    ...
    let field = Metaya.getPlayMetaDataByField(playID: data.playID, field: fieldToSearch) ?? panic("Play doesn't exist")
